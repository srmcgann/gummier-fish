...
<html>
	...
	<body onresize="resize()">
		...
		<div id="masterContainer">
			<center>
				<div id="header">
					<a href="<?php echo $baseURL?>" style="color:#def;text-decoration:none;cursor: pointer;">
						LOOKIE.ml
					</a>
				</div>
					...
					<?php
						...
						for($i=0;$i<mysqli_num_rows($res);++$i){
							...
							if($row['public']){								
								...
								?><a href="<?php echo $fileName;?>"><img src="<?php echo $fileName.".jpg"?>" alt="<a href='<?php echo $baseURL?>?i=<?php echo $row['shortName']?>' target='_blank'><?php echo $row['name']?><a>"></a><?php 
							}
						}
					?>
				</div>
				...
				<div id="footer">
					<?php
						?><a href="<?php echo $baseURL?>" style="text-decoration:none;"><span class="footerLink">Home Page</span></a><?
						?><a href="admin" style="text-decoration:none;"><span class="footerLink">Admin Page</span></a><?php
						?><a href="mailto:s.r.mcgann@hotmail.com" style="text-decoration:none;"><span class="footerLink">Email Author</span></a><?php
