...
error_reporting(E_ALL);
	...
	if($_GET['i']){
      ...
      $tfs=filesize("uploads/$base".suffix($type));
			$size=$tfs?$tfs:0;
			...
			$src="//{$_SERVER['HTTP_HOST']}/uploads/$base".suffix($type);
				...
				<html>
					<head>
						...
						<meta name="og:image" content="<?php echo $src?>.jpg" />
						<link rel="stylesheet" type="text/css" href="//<?php echo $_SERVER["HTTP_HOST"];?>/render.css">
						<link rel="shortcut icon" type="image/png" href="//<?php echo $_SERVER["HTTP_HOST"];?>/favicon.png"/>
						<title>Lookie! (<?php echo $name?>)</title>
						<link href="//<?php echo $_SERVER["HTTP_HOST"];?>/zoom/imageviewer.css"  rel="stylesheet" type="text/css" />
						<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
						<script src="//<?php echo $_SERVER["HTTP_HOST"];?>/functions.js?4"></script>
						<script src="//<?php echo $_SERVER["HTTP_HOST"];?>/zoom/imageviewer.js"></script>
						<script>
							init=0;
							setInterval(resize,1000);
							url="//<?php echo $_SERVER["HTTP_HOST"]."/$shortName";?>";
							pimg1=new Image();
						...
						<div id="header">
							<a href="." style="color:#abc;text-decoration:none;cursor: pointer;">
								<div style="width:170px;">
									<div style="background:url(//<?php echo $_SERVER['HTTP_HOST']?>/cloud.png);background-size:100% 100%;width:45px;height:35px;float:left;margin-right:10px;"></div>
									LOOKIE
								</div>
							</a>
							<br><br>
														...
														echo '<tr>';
															...
															<script>
																...
																$('.rate_widget').each(function(i) {
																	...
																	$.post(
																		'//<?php echo $_SERVER['HTTP_HOST']?>/ratings.php',
																		out_data,
																		function(INFO) {
																			$(widget).data( 'fsr', INFO );
																			set_votes(widget);
					...
					<div id="innerDivLeft">
						<div class="upload">
							<div id="uploadInner">
								...
								<div class="downloadURL_div">
									Or, URL
									<input onclick="$(this).select()" onkeypress="handleKeypress2(event)" id="inputURL" class="inputURL" type="text" name="downloadURL">
									<button onclick="download()" class="goButton">Go</button>
								</div>
								<div class="downloadURL_div">
									<div class="dataURLCaption">
                    data URL
                    <input onclick="$(this).select()" onkeypress="handleKeypress1(event)" id="dataURL" class="inputURL" type="text" name="dataURL">
                  </div>
								</div>
							</div>
