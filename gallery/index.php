...
<html>
	...
	<body onresize="resize()">
		...
		<center>
			...
			<div id="menu">
				<?php
					?><a href="../"><span class="footerLink">Home</span></a><?php
					?><a href="../admin"><span class="footerLink">Admin</span></a><?php
					?><a href="mailto:s.r.mcgann@hotmail.com"><span class="footerLink" style="margin-right:0;">Contact</span></a><?php
				?>
			</div>
			<div id="gallery"></div>
		</center>
